...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('public/assets/app/page/user/css/detail.css')}}">
@endsection
@section('content')
...
@section('js')
    <script src="{{asset('public/assets/app/page/user/js/jquery.sticky.js')}}"></script>
    ...
    <script src="{{asset('public/assets/app/page/user/js/detail.js')}}"></script>
@endsection