<div class="mobile-nav-wrapper" role="navigation">
    ...
    <ul id="MobileNav" class="mobile-nav">
        <li class="lvl1 parent megamenu">
            <a href="{{route('main.home.get')}}">Home <i class="anm anm-plus-l"></i></a>
        </li>
        <li class="lvl1 parent megamenu">
        ...
        <li class="lvl1 parent megamenu">
            <a href="./detail.html">Product <i class="anm anm-plus-l"></i></a>
            <ul>
                <li>
                    <a href="./detail.html" class="site-nav">Product Page<i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="./detail.html" class="site-nav">Product Layout 1</a></li>
